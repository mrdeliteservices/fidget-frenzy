...
export default function StressBall() {
  ...
  const squeeze = async () => {
    ...
    Animated.sequence([
      Animated.spring(scale, { toValue: 0.82, useNativeDriver: true, speed: 14, bounciness: 0 }),
...
const styles = StyleSheet.create({
  ...
  ball: {
    ...
    backgroundColor: BRAND.purple, shadowColor: BRAND.gold, shadowOpacity: 0.5, shadowRadius: 18, shadowOffset: { width: 0, height: 0 },
